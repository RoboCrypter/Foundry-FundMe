...
contract HelperConfig is Script {
    ...
    int256 private constant INITIAL_ANSWER = 1000e8;   // Means "ETH" price is "1k something" currently at this time.
    ...
    function getSepoliaNetworkConfig() public pure returns(NetworkConfig memory) {
        ...
        NetworkConfig memory sepoliaEthConfig = NetworkConfig({ priceFeedAddress: 0x694AA1769357215DE4FAC081bf1f309aDC325306 });
    ...
    function getAnvilNetworkConfig() public returns(NetworkConfig memory) {
        ...
        if(activeNetworkConfig.priceFeedAddress != address(0)) {   // If we already setted up a mock priceFeedAddress then just return that priceFeedAddress.
